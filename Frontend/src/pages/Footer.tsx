...
const Footer = () => {
  ...
  return (
    <footer className="relative mt-24 overflow-hidden border-t border-white/10 bg-[#050713] text-white">
      <div className="pointer-events-none absolute inset-0 bg-linear-to-r from-purple-600/10 via-indigo-600/10 to-violet-600/10" />
      <div className="pointer-events-none absolute -top-24 left-1/2 h-64 w-64 -translate-x-1/2 rounded-full bg-purple-600/20 blur-xl" />

      <div className="relative px-6 py-14">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <div className="mb-4 flex items-center gap-3">
              <div className="rounded-2xl bg-white/10 p-3 shadow-lg shadow-purple-500/20">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <span className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs text-gray-300">
                <ShieldCheck size={16} />
                ATS Optimized
              </span>
              <span className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs text-gray-300">
            ...
            <div className="flex gap-3">
              {socialIcons.map((Icon, index) => (
                <a
                  key={index}
                  href="#"
                  className="rounded-2xl border border-white/10 bg-white/5 p-3 text-gray-300 transition-all duration-300 hover:-translate-y-1 hover:border-purple-400/50 hover:bg-purple-500/20 hover:text-white hover:shadow-lg hover:shadow-purple-500/20"
                >
                  <Icon size={20} />
                </a>
              ))}
